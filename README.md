<h1 align="center">Secret API Keys Collection ✨</h1>
<p align="center">
...
Agora API Keys|✅|https://docs.agora.io/en/rtc/restfulapi/|
Airtable API Key|✅|https://airtable.com/api
Akamai API Credentials|✅|https://developer.akamai.com/api
Algolia Keys|✅|https://www.algolia.com/doc/
Alibaba Cloud Keys|✅|https://www.alibabacloud.com/help/product/28625.htm
Amazon MWS Token|✅|https://docs.developer.amazonservices.com/en_UK/dev_guide/DG_IfNew.html
AMQP Credentials|✅|https://docs.gitguardian.com/secrets-detection/detectors/specifics/amqp_credentials
Anypoint Keys|✅|https://docs.mulesoft.com/api-manager/1.x/tutorials
Artifactory Token|✅|https://www.jfrog.com/confluence/display/JFROG/Artifactory+REST+API
Asana Key|✅|https://asana.com/guide/help/api/api
Atlassian Oauth2 Keys|✅|https://developer.atlassian.com/cloud/jira/platform/oauth-2-authorization-code-grants-3lo-for-apps/
Auth0 Keys|✅|https://auth0.com/docs/
AWS Keys|✅|https://docs.aws.amazon.com/IAM/latest/APIReference/welcome.html
Azure DevOps Personal Access Token|✅|https://docs.microsoft.com/en-us/azure/devops/cli/log-in-via-pat?view=azure-devops&tabs=windows
Azure Service Management Certificate|✅|https://docs.microsoft.com/en-us/azure/cloud-services/cloud-services-certs-create
Azure Subscription Key|✅|https://docs.microsoft.com/en-us/azure/
Beamer API Key|✅|https://www.getbeamer.com/api
Bitbucket Keys|✅|https://support.atlassian.com/bitbucket-cloud/docs/use-oauth-on-bitbucket-cloud/
Bitfinex Keys|✅|https://docs.bitfinex.com/docs
Buildkite API Token|✅|https://buildkite.com/docs/apis/managing-api-tokens
Checkout.com API Secret Key|✅|https://api-reference.checkout.com/
CircleCI Personal Token|✅|https://circleci.com/docs/api/v2/#circleci-api
Clarifai Key|✅|https://docs.clarifai.com/api-guide/api-overview
Clearbit Key|✅|https://clearbit.com/docs#api-reference
Clockwork Key|✅|https://www.clockworksms.com/doc/
Clojars Deploy Token|✅|https://github.com/clojars/clojars-web/wiki/Deploy-Tokens
Cloudant Credentials|✅|https://cloud.ibm.com/apidocs/cloudant
Cloudera Model Key|✅|https://docs.cloudera.com/documentation/data-science-workbench/latest/topics/cdsw_models.html#call_model__access_key
Cloudflare API Credentials|✅|https://api.cloudflare.com/
CloudSight Key|✅|https://cloudsight.docs.apiary.io/
Codacy API Credentials|✅|https://docs.codacy.com/codacy-api/using-the-codacy-api/
Codeclimate key	Code|✅|https://developer.codeclimate.com/
Codecov API Key|✅|https://docs.codecov.io/reference
Codepush API Key|✅|https://docs.microsoft.com/en-us/appcenter/distribution/codepush/cli
Coinbase Keys|✅|https://developers.coinbase.com/
Confluent Keys|✅|https://docs.confluent.io/cloud/current/client-apps/api-keys.html
Contentful Content Delivery API Key|✅|https://www.contentful.com/developers/docs/references/content-delivery-api
Contentful Content Management API Key|✅|https://www.contentful.com/developers/docs/references/content-management-api
Contributed Systems Faktory Password|✅|https://github.com/contribsys/faktory/wiki/Installation#docker
Contributed Systems Sidekiq API Key|✅|https://sidekiq.org/
Coveralls Personal Token|✅|https://coveralls.io/api/docs
Coveralls Repository Token|✅|https://docs.coveralls.io/api-introduction
Crates.io Key|✅|https://docs.gitguardian.com/secrets-detection/detectors/specifics/crates_io_key
Databricks Authentication Token|✅|https://docs.databricks.com/dev-tools/api/index.html
Datadog API Credentials|✅|https://docs.datadoghq.com/account_management/api-app-keys/#api-keys
...
Microsoft Teams webhook|✅|https://docs.microsoft.com/en-us/microsoftteams/platform/webhooks-and-connectors/how-to/connectors-using
